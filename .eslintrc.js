...
module.exports = {
  ...
  plugins: ['@typescript-eslint', 'playwright', 'vitest', 'prettier'],
  extends: [
    'eslint:recommended',
    ...
    // ============================================
    {
      ...
      rules: {
        ...
        'no-restricted-syntax': [
          ...
          {
            selector:
              "CallExpression[callee.property.name='locator'][arguments.0.value=/^\\/\\//]",
            message:
              'XPath selectors are prohibited. Use user-facing locators (getByRole, getByText) or test IDs (getByTestId) instead.',
          },
          {
            selector:
              "CallExpression[callee.property.name='locator'][arguments.0.value=/^xpath=/i]",
            message:
              'XPath selectors are prohibited. Use user-facing locators (getByRole, getByText) or test IDs (getByTestId) instead.',
          },
        ],
