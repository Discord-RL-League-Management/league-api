...
export class GuildFilteringService {
  ...
  async getUserAvailableGuildsWithPermissions(userId: string): Promise<any[]> {
    this.logger.warn('GuildFilteringService.getUserAvailableGuildsWithPermissions is deprecated. Use UserGuildsService instead.');
  ...
  async syncUserGuildMemberships(userId: string, userGuilds: DiscordGuild[]): Promise<void> {
    this.logger.warn('GuildFilteringService.syncUserGuildMemberships is deprecated. Use UserGuildsService instead.');
