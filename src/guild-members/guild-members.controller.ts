import { Controller, Get, Post, Patch, Delete, Param, Query, UseGuards, Logger, Body } from '@nestjs/common';
...
export class GuildMembersController {
  ...
  async updateMember(
    ...
    return this.guildMembersService.update(userId, guildId, updateGuildMemberDto);
  }
