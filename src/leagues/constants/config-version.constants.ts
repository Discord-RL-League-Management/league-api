...
/**
 * Current schema version for league configuration
 * Increment when making breaking changes to LeagueConfiguration structure
 */
export const CURRENT_SCHEMA_VERSION = 1;

/**
 * Current configuration version (semantic version)
